...
// Fix duplicate ID 109: move Hospitality to 110
const health = articles.find(a => a.slug === 'uk-ltd-health-beauty-wellness-business-2026');
const hospitality = articles.find(a => a.slug === 'uk-ltd-hospitality-tourism-business-2026');
console.log('Before fix:');
console.log('  Health ID:', health && health.id);
console.log('  Hospitality ID:', hospitality && hospitality.id);

if (health && hospitality && health.id === hospitality.id) {
    hospitality.id = 110;
    console.log('  -> Moved Hospitality to ID 110');
}
...
addArticle('uk-ltd-waste-management-recycling-business-2026', {
...
addArticle('uk-ltd-food-beverage-restaurant-business-2026', {
...
addArticle('uk-ltd-wedding-planning-event-design-business-2026', {
...
console.log('ID 109:', articles.find(a => a.id === 109) && articles.find(a => a.id === 109).slug);
console.log('ID 110:', articles.find(a => a.id === 110) && articles.find(a => a.id === 110).slug);
console.log('ID 111:', articles.find(a => a.id === 111) && articles.find(a => a.id === 111).slug);
console.log('ID 112:', articles.find(a => a.id === 112) && articles.find(a => a.id === 112).slug);
console.log('ID 113:', articles.find(a => a.id === 113) && articles.find(a => a.id === 113).slug);
console.log('ID 114:', articles.find(a => a.id === 114) && articles.find(a => a.id === 114).slug);
console.log('ID 115:', articles.find(a => a.id === 115) && articles.find(a => a.id === 115).slug);
